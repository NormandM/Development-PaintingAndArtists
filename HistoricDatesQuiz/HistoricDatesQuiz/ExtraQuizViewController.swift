...
class ExtraQuizViewController: ViewController {
    ...
    var viewTitleExtra = String()
    var selectedSubjectExtra = String()
    var selectedTitleExtra = String()
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        questionLabelExtra.isHidden = false
    ...
    override func viewWillDisappear(_ animated: Bool) {
        questionLabelExtra.isHidden = true
    ...
    func tryAgainExtra() {
        ...
        let randomizeQuestion = RandomizeQuestion(date: dateExtra, event: eventExtra)
        indexDateExtra = randomizeQuestion.generateDateIndex(from: 0, to: dateExtra.count - 1, quantity: nil)
        let labelAndButtonDisplayExtra = toDisplayButtonsAndLabelsExtra()
        timerLabelExtra.isHidden = true
        labelAndButtonDisplayExtra.buttonFormat(event: eventExtra, indexEvent: indexEventExtra)
        labelAndButtonDisplayExtra.labelFormat()
        labelAndButtonDisplayExtra.allShown()
        labelAndButtonDisplayExtra.startQuizExtra()
        buttonCreditExtra.setTitle("credits: \(creditExtra)", for: .normal)
        labelFirstDateExtra.text = dateExtra[0] + " " + unitsExtra[0]
        labelSecondDateExtra.text = dateExtra[1] + " " + unitsExtra[1]
        labelThirdDateExtra.text = dateExtra[2] + " " + unitsExtra[2]
    ...
    func toDisplayButtonsAndLabelsExtra() ->  LabelAndButtonDisplayExtra{
        let labelAndButtonDisplayExtra = LabelAndButtonDisplayExtra(firstEventExtra: firstEventExtra, labelSecondEventExtra: labelSecondEventExtra, labelThirdEventExtra: labelThirdEventExtra, labelFourthEventExtra: labelFourthEventExtra, labelFifthEventExtra: labelFifthEventExtra, labelFirstDateExtra: labelFirstDateExtra, labelSecondDateExtra: labelSecondDateExtra, labelThirdDateExtra: labelThirdDateExtra, labelFourthDateExtra: labelFourthDateExtra, labelFifthDateExtra: labelFifthDateExtra, buttonFirstDateExtra: buttonFirstDateExtra, buttonSecondDateExtra: buttonSecondDateExtra, buttonThirdDateExtra: buttonThirdDateExtra, buttonFourthDateExtra: buttonFourthDateExtra, buttonFifthDateExtra: buttonFifthDateExtra, buttonSixthDateExtra: buttonSixthDateExtra, buttonCreditExtra: buttonCreditExtra)
    ...
    @IBAction func toMenu(_ sender: Any) {
        performSegue(withIdentifier: "unwindToMenu", sender: (Any).self)
    }
